...
considérée \gls{anthropocentre}e.
...
\item[Déplier/replier une tâche] Comme vu précédemment (à la section
  \ref{sec:accordeon} page \ref{sec:accordeon}), un bouton permet
  d'afficher ou de masquer les sous-tâches d'une tâche. Au démarrage
  de l'application, seules les tâches dites « racines » (sans tâche
  mère) sont visibles.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{img/sobre.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{img/connue.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{img/sexy.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{img/massboutons.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{img/paramvote.jpg}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=11cm]{img/croixgroupevote.jpg}
