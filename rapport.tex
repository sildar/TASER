...
\item[Déplier/replier une tâche] Comme vu précédemment (à la section
  ...
  de l'application, seules les \glslink{tachePrincipale}{tâches
    principales} sont visibles.
...
pertinent. C'est à dire, devait-on faire la distinction entre les
...
puis supprime la tâche créée au mauvaise endroit et comprend où il
...
Cela nous permet d'une part d'utiliser un raccourcis simple et connu
...
sommes pas satisfait. Nous avions pensé à différentes alternatives:
\begin{itemize}
\item squelette
\item modèle
\item schéma
\end{itemize}
Mais aucun d'eux nous nous semblaient vraiment meilleurs c'est
pourquoi nous utilisons encore le terme « template ».
...
par exemple pas pensé à enregistrer l'entretient avec l'expert), nous
